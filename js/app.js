(() => {
    ...
    copyBtn?.addEventListener("click", () => {
        const text = document.querySelector(".address")?.textContent?.trim();
        if (text) {
            ...
            setTimeout(() => {
                copyBtn.classList.remove("tooltip-visible");
            }, 1500);
        }
    });
    ...
    const buttonPopup = document.querySelector(".js-button");
    buttonPopup?.addEventListener("click", function(e) {
        if (document.querySelector("#nice")) setTimeout(() => {
